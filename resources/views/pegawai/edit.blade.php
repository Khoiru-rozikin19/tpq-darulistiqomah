...
@section('page_title', 'Form Edit Data Pegawai')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
        <div class="p-6 bg-gradient-to-r from-blue-700 to-blue-800 text-white">
            <h3 class="text-lg font-bold heading-font">Edit Data Pegawai: {{ $pegawai->nama }}</h3>
            <p class="text-xs text-blue-100 mt-1">Silakan sesuaikan formulir di bawah ini dengan data pegawai yang terbaru.</p>
        </div>
        ...
        <form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST" class="p-6 md:p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="nip" id="nip" value="{{ old('nip', $pegawai->nip) }}" placeholder="Contoh: 19851025..." 
                    ...
                    <div>
                        ...
                        <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', $pegawai->jabatan) }}" required placeholder="Contoh: Kepala Madrasah, Admin TU, Guru" 
            ...
            <div class="pt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $pegawai->nama) }}" required placeholder="Masukkan nama lengkap beserta gelar" 
                    ...
                    <div>
                        ...
                        <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $pegawai->no_hp) }}" placeholder="Contoh: 0812xxxxxxxx" 
                            class="w-full px-3.5 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs text-slate-700 bg-slate-50/50">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat" id="alamat" rows="3" placeholder="Masukkan alamat lengkap domisili pegawai saat ini" 
                            class="w-full px-3.5 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs text-slate-700 bg-slate-50/50">{{ old('alamat', $pegawai->alamat) }}</textarea>
                    </div>
                </div>
            </div>
