...
echo -e "  📋 Cek status Nginx     : ${BOLD}sudo systemctl status nginx${NC}"
echo -e "  📋 Cek status PHP-FPM   : ${BOLD}sudo systemctl status php${PHP_VERSION}-fpm${NC}"
echo -e "  📋 Cek log Laravel      : ${BOLD}tail -f ${APP_DIR}/storage/logs/laravel.log${NC}"
echo -e "  📋 Clear cache          : ${BOLD}cd ${APP_DIR} && php artisan optimize:clear${NC}"
echo -e "  📋 Re-cache production  : ${BOLD}cd ${APP_DIR} && php artisan optimize${NC}"
echo -e "  📋 Re-seed database     : ${BOLD}cd ${APP_DIR} && php artisan migrate:fresh --seed${NC}"
echo ""
